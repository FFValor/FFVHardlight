...
public partial class InventorySystem
{
    public void InitializeRelay()
    {
        ...
        SubscribeLocalEvent<InventoryComponent, RefreshEquipmentHudEvent<NVHudComponent>>(RefRelayInventoryEvent); // Goobstation
        SubscribeLocalEvent<InventoryComponent, RefreshEquipmentHudEvent<IRHudComponent>>(RefRelayInventoryEvent); // Goobstation
